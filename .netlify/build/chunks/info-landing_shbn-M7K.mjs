import { a as createComponent, r as renderTemplate, m as maybeRenderHead, b as renderComponent, d as addAttribute, c as createAstro } from './astro/server_DlAcna1r.mjs';
import { d as $$Icon, e as Button, a as cn, b as buttonVariants } from './main-layout_CyfB8DwD.mjs';
import { $ as $$HeaderSection } from './header-section_QU5omrOM.mjs';
...
}, "/Users/jdbohrman/www.runportcullis.co/src/components/sections/features.astro", undefined);
...
</p> <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4"> <a href="/pricing"`, "> <span>Get a free 1-week trial</span> ", ` </a> </div> </div> </section> <script>
...
<\/script>`])), maybeRenderHead(), addAttribute(cn(
    ...
    "px-4"
  ), "class"), addAttribute(cn(buttonVariants({ size: "lg", rounded: "full" }), "gap-2 bg-black text-white hover:opacity-90 transition-all duration-300 shadow-md"), "class"), renderComponent($$result, "Icon", $$Icon, { "name": "lucide:slack", "class": "mr-2 text-[#faff69] size-4" }));
}, "/Users/jdbohrman/www.runportcullis.co/src/components/sections/hero-landing.astro", undefined);
...
}, "/Users/jdbohrman/www.runportcullis.co/src/components/sections/info-landing.astro", undefined);

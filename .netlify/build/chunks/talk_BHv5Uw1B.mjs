  ...
  useEffect(() => {
    async function loadClient() {
      try {
        ...
        const { DailyTransport } = await import("./index.module_Bn0qhtNa.mjs");
...
const $$Talk = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Talk to Portcullis", "mainClass": "flex-1 bg-background-200" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="flex items-center justify-center min-h-screen"> <div class="flex flex-col gap-4 w-full max-w-[58rem] items-center p-4"> ${renderComponent($$result2, "Assistant", Assistant, {})} </div> </section> ` })}`;

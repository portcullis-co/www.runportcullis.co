...
const $$ClickhouseSupport = createComponent(($$result, $$props, $$slots) => {
  ...
  const pageDescription = "Professional deployment support services to ensure your Clickhouse runs smoothly and efficiently.";
...
</p> <div class="-mb-5 flex gap-3 border-t border-muted py-4 md:-mb-7"> ${renderComponent($$result2, "Button", Button, { "variant": "secondary", "size": "sm", "rounded": "xl", "className": "px-4" }, { "default": ($$result3) => renderTemplate` <a href="/schedule-a-chat" class="flex items-center gap-2" id="intercom-button-6"> <span>Discuss Project</span> ${renderComponent($$result3, "Icon", $$Icon, { "name": "lucide:arrow-up-right", "class": "size-4" })} </a> ` })} </div> </div> </div> </div> </div> </div> </section> ${renderComponent($$result2, "ProcessSteps", $$ProcessSteps, {})} ` }));
}, "/Users/jdbohrman/www.runportcullis.co/src/pages/services/clickhouse-support.astro", undefined);

...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_DauHcdrN.mjs'
    ).then(n => n.t).catch((e) => {
...
}, "/Users/jdbohrman/www.runportcullis.co/node_modules/.pnpm/astro@4.16.18_@types+node@22.10.7_rollup@4.31.0_typescript@5.7.3/node_modules/astro/components/Image.astro", undefined);
...
}, "/Users/jdbohrman/www.runportcullis.co/node_modules/.pnpm/astro@4.16.18_@types+node@22.10.7_rollup@4.31.0_typescript@5.7.3/node_modules/astro/components/Picture.astro", undefined);

const id = "why-we-bet-on-clickhouse.md";
const collection = "blog";
const slug = "why-we-bet-on-clickhouse";
const body = `
...
const data = { title: "Why Portcullis is betting on Clickhouse for our petabyte-scale solution studio", description: "Learn the thought process that went into staking our brand and business model on Clickhouse, the fastest OLAP database", cover: "/blog/blog-cover-announcement.png", category: "insights", pubDate: /* @__PURE__ */ new Date(17303472e5) };
const _internal = {
  type: "content",
  filePath: "/Users/jdbohrman/www.runportcullis.co/src/content/blog/why-we-bet-on-clickhouse.md",
  rawData: void 0
};
export {
  _internal,

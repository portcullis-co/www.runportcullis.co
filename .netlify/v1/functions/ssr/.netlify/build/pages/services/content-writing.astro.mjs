...
import { $ as $$HeroSection } from "../../chunks/hero-section_uIkoZzoW.mjs";
import { $ as $$MainLayout, d as Button } from "../../chunks/main-layout_B4Exvwy_.mjs";
import { $ as $$Icon } from "../../chunks/Icon_D1AcebVk.mjs";
...
const $$ContentWriting = createComponent(($$result, $$props, $$slots) => {
  ...
  const pageDescription = "High-quality, professional data warehouse-focused content writing services to boost your brand's visibility and engagement.";
  const steps = [
    {
      number: "01",
      title: "Assessment",

...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"2025-clickhouse-support-report.md": {
	id: "2025-clickhouse-support-report.md";
  slug: "2025-clickhouse-support-report";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
"building-a-vintage-recommendation-engine-part-1.md": {
	id: "building-a-vintage-recommendation-engine-part-1.md";
  slug: "building-a-vintage-recommendation-engine-part-1";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
"bulk-data-clickhouse.md": {
	id: "bulk-data-clickhouse.md";
  slug: "bulk-data-clickhouse";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
...
"clickhouse-2025-roadmap.md": {
	id: "clickhouse-2025-roadmap.md";
  slug: "clickhouse-2025-roadmap";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
